...
The operator closes the three in a second session and finalizes. `/cost` is not available under
the operator's subscription; no token figure for this session.
